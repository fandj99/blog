...
export default {
    data(){
        return{
          ...
          img2,
            FriendshipData:[
              {link:"https://github.com/fandj99", imgUrl: img1, nickName: "fandj99", introduce:"帅气boy"},
              {link:"https://github.com/chencd97", imgUrl: img2, nickName: "chencd97", introduce:"帅气boy"},
            ]
        }
    },
    mounted(){
